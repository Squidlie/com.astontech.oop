...
public abstract class MySQL {
    ...
    protected static void Connect(){
        ...
        try {
            connection = DriverManager.getConnection("jdbc:mysql://" + dbHost + ":3306/" + dbName + "?useSSL=" + useSSL + "&noAccessToProcedureBodies=" + procBod + "&zeroDateTimeBehavior=convertToNull&autoReconnect=true&characterEncoding=UTF-8&characterSetResults=UTF-8", dbUser, dbPass
            );
        } catch (
                SQLException ex) {
